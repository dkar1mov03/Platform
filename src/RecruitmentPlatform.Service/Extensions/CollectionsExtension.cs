...
using RecruitmentPlatform.Service.Configurations;
...
namespace RecruitmentPlatform.Service.Extensions
{
    public static class CollectionsExtension
    {
            ...
            where TEntity : Auditable
        {
            ...
            return @params.PageIndex > 0 && @params.PageSize > 0 ?
                ...
                : throw new RecruitmentException(400, "Please, enter valid numbers");
        }
